  ...
  var chapters = [
    {
      ...
      sections: [
        {
          title: '不用学操作，说人话就行',
          paragraphs: ['过去四十年我们用软件，都是软件先摆出一堆固定的按钮和菜单，**你得先学会它的规则**。想做个数据透视表？先学在哪个菜单里、点几下、参数怎么填。学不会，这个功能对你就等于不存在。', '现在反过来了。**你说人话，它去办。**不用记菜单在哪，也不用学函数怎么写。你怎么跟同事交代，就怎么跟它说。', '**Word、Excel、SAP 要你去适应它们，AI 反过来适应你。**这是它跟以前那些软件最大的区别。'],
          bullets: [
            ...
            { term: '但它会出错，而且看不出来', explain: '固定按钮不会给你错的结果，最多是你点错了。AI 每次都是现造的，**造出来很顺，整段也可能是错的**。这是它跟传统软件最大的差别，后面几节都在讲这件事。' },
          ],
          demo: {
            type: 'shift',
            title: '同一件事，两种做法',
        ...
        },
        {
          ...
          bullets: [
            { term: '你说什么，它都能接上', explain: '像相声演员接梗。你抛什么他都接得住，而且接得又快又溜。它的本事就是**让这段话顺下去**。至于这话是真是假，它没有这个概念。所以「答得特别顺」，一点都不说明它答得对。' },
            { term: '它会一本正经地胡说', explain: '它的任务是让这句话**看起来像个答案**。至于这件事是真是假，它不负责确认。没资料的时候它照样能顺畅地写下去，编出一个不存在的数字或出处。而且编的时候语气和说真话时**一模一样**，你看不出来。' },
            { term: '让它算账，它会算错', explain: '问它 7×8，它答得对。这道题它见过几百万遍，等于在背答案。换成 4783×926，它没背过，就给你一个「看着像那么回事」的数字。**它从头到尾没做过一次计算**，只是在猜这串数字后面该跟什么。所以报表里的加总和百分比别让它心算，让它写公式，或者你自己按计算器。' },
          ],
          demo: {
            type: 'typewriter',
            title: '看它怎么编出一个数字',
        ...
        {
          title: '关掉对话，它就把你忘了',
          paragraphs: ['它能看到的，只有这一轮对话里的内容。**像同事帮你干活时手边摊开的那摞资料，资料一收走，他什么都不记得了。**（这摞资料有个术语叫「上下文」，你会经常听到。）', '而且这张桌子就那么大。你不停往上放新资料，最早那几张会被挤下去，从桌上掉到地上。它再也看不见了。你这边的感受就是**聊到后面它开始前后矛盾，把你刚否掉的方案又提一遍**。'],
          bullets: [
