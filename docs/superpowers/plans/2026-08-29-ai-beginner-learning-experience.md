...
- [ ] **Step 2: 实现安全的 sessionStorage 降级**
...
- [ ] **Step 4: 建立基础样式变量和 reduced-motion**
...
- [ ] **Step 1: 在 detail.html 注册六个结构为 learning 的章节**
